...
@Component({
  ...
  template: `
    <div class="relative">
      ...
      @if (isOpen()) {
        <div 
          class="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden animate-fade-in"
...
export class NavigationDropdownComponent {
  ...
  private async addEmployee(): Promise<void> {
    this.navigationService.navigateToAddEmployee();
  }

  private refreshData(): void {
    this.navigationService.refreshData();
  }
